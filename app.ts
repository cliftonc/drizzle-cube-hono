...
const databaseUrl = 'postgresql://drizzle_user:drizzle_pass123@localhost:54927/drizzle_cube_db'
...
app.use('*', logger())
app.use('*', cors({
  origin: ['http://localhost:4010', 'http://localhost:4011', 'http://localhost:5173'], // Add your frontend URLs
